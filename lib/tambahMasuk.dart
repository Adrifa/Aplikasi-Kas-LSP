...
class tambahMasuk extends StatefulWidget {
  @override
  _tambahMasukState createState() => _tambahMasukState();
}

class _tambahMasukState extends State<tambahMasuk> {
